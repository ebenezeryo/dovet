      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto rounded-3xl p-6 sm:p-8 bg-white border-slate-100 shadow-2xl">
        <DialogHeader className="border-b border-slate-100 pb-4">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="h-11 w-11 rounded-2xl bg-[#eaf1ef] text-[#3C594E] flex items-center justify-center font-bold">
        ...
        <form onSubmit={handleSubmit} className="enrollment-form space-y-6 pt-2">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="academic" className="space-y-5 pt-4">
              <div className="rounded-2xl bg-slate-50/70 p-4 border border-slate-200/60 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      className="h-11 rounded-xl text-xs font-semibold bg-white border-slate-200"
                      required
                    />
                  </div>
              ...
              <div className="rounded-2xl bg-slate-50/70 p-4 border border-slate-200/60 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-xs font-bold text-slate-700">Current Term</Label>
                    <Select
            ...
            <TabsContent value="personal" className="space-y-5 pt-4">
              <div className="rounded-2xl bg-slate-50/70 p-4 border border-slate-200/60 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-xs font-bold text-slate-700">Country / Nationality</Label>
                    <Input
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="space-y-1.5">
                    <Label className="text-xs font-bold text-slate-700">State of Origin</Label>
                    <Input
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-xs font-bold text-slate-700">Place of Worship</Label>
                    <Input
              ...
              <div className="rounded-2xl bg-slate-50/70 p-4 border border-slate-200/60 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <Label className="text-xs font-bold text-slate-700">House (Inter-House Sport)</Label>
                    <Select
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-xs font-bold text-slate-700">Last School Attended</Label>
                    <Input
                ...
                <div className="space-y-1.5">
                  ...
                  <Textarea
                    ...
                    className="rounded-xl text-xs bg-white border-slate-200 min-h-[70px]"
                  />
                </div>

                <div className="space-y-1.5">
                  <Label className="text-xs font-bold text-slate-700">Family Hospital Address</Label>
                  <Input
            ...
            <TabsContent value="guardian" className="space-y-5 pt-4">
              <div className="rounded-2xl bg-slate-50/70 p-4 border border-slate-200/60 space-y-4">
                <h4 className="font-bold text-xs uppercase tracking-wider text-[#3C594E] flex items-center gap-1.5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <Label className="text-xs font-bold text-slate-700">Parent or Guardian Name</Label>
                    <Input
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-xs font-bold text-slate-700">Parent Marital Status</Label>
                    <Select
            ...
            <TabsContent value="parents" className="space-y-5 pt-4">
              {/* Father Section */}
              <div className="rounded-2xl bg-slate-50/70 p-4 border border-slate-200/60 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-xs font-bold text-slate-700">Father's Phone No.</Label>
                    <Input
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-xs font-bold text-slate-700">Father's Email Address</Label>
                    <Input
                      type="email"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <Label className="text-xs font-bold text-slate-700">Father's Place of Work</Label>
                    <Input
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-xs font-bold text-slate-700">Father's Contact Address</Label>
                    <Input
              ...
              <div className="rounded-2xl bg-slate-50/70 p-4 border border-slate-200/60 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="space-y-1.5">
                    <Label className="text-xs font-bold text-slate-700">Mother's Name</Label>
                    <Input
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-xs font-bold text-slate-700">Mother's Phone No.</Label>
                    <Input
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-xs font-bold text-slate-700">Mother's Email Address</Label>
                    <Input
                      type="email"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <Label className="text-xs font-bold text-slate-700">Mother's Place of Work</Label>
                    <Input
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-xs font-bold text-slate-700">Mother's Contact Address</Label>
                    <Input
          ...
          <DialogFooter className="border-t border-slate-100 pt-4 flex flex-col-reverse sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="rounded-xl h-11 px-5 font-semibold text-xs border-slate-200"
              >
                Cancel
              </Button>
              <Button
                ...
                className="rounded-xl h-11 px-7 font-bold text-xs text-white shadow-sm"
